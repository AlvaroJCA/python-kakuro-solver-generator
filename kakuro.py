                            ...
                            if i == br - 1 and j == bc - 1:
                                ...
                                if b[i-1][j+1] > 0:
                                 ...
                                 if tsquares <= len(tvalues) and lsquares <= len(lvalues):
                                     ...
                                     tvalues.add(v)
                                     lvalues.add(v)
                                     tclue = tclue if tclue > sum(tvalues) else getRandomClueBySquaresValues(tsquares, tvalues)
                                     b[tx][j]['B'] = (tclue, tsquares, tvalues)
                                     lclue = lclue if lclue > sum(lvalues) else getRandomClueBySquaresValues(lsquares, lvalues)
